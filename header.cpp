...
LTexture pJump[10];
//background texture
LTexture forest, road, tree1, tree2, mashroom, bush1, bush2, bush3, water1, water2, path1;
...
LTexture try_button, try_button_sh, mainmenu_button, mainmenu_button_sh, gameover;
LTexture obs[10];
